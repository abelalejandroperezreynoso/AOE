...
const RAMPS = {
  ...
  '#b08a52': ['#c9a76d', '#8d6d3f'], // mimbre del cesto de la grúa
  '#a8926a': ['#c2ae8b', '#8b7855'], // tierra pisada del tajo
...
export const LOOK = {
  ...
  building: {
    ...
    miningcamp: {
      wood: '#7e5c31', roof: '#c6ae86', stone: '#8f9298', accent: '#82868d',
      metal: '#9aa4ad', soil: '#a8926a', ivy: '#4a8a3a',
    },
...
export const LOOK_FIELDS = {
  ...
  building: [
    ...
    color('ground', 'Empedrado'), color('wicker', 'Mimbre'), color('metal', 'Herramientas'),
    color('counter', 'Mostradores'), color('accent', 'Detalle'),
